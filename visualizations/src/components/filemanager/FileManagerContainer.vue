<template>
    <div class="home">
        ...
        <b-row class="fileOptionContainer">
            <b-col cols="1" md="auto"><h3>Option 3a</h3></b-col>
            <b-col>
                <h3>Load some iroh demo files</h3>
                <div style="margin: 10px 0px;">
                    <form>
                        <b-button @click="loadExamplesIroh()" variant="primary">Load iroh .qlog files</b-button>
                    </form>
                </div>
                <div>
                    <p>
                        This will load example files generated by iroh.
                    </p>
                </div>
            </b-col>
        </b-row>
...
<script lang="ts">
    ...
    export default class FileManagerContainer extends Vue {
        ...
        public loadExamplesIroh(){
            let alreadyLoaded = false;
            for (const  group of this.store.groups ){
                if ( group.filename.indexOf("IROH") === 0 ){
                    alreadyLoaded = true;
                    break;
                }
            }
            ...
            if ( alreadyLoaded ){
                ...
                Vue.notify({
                    ...
                    title: "Example files already loaded",
                    type: "warn",
                    text: "Example files were already loaded, check for files with the 'IROH_' prefix.",
                });

                return;
            }

            this.store.loadExamplesForDemoIroh();
        }
